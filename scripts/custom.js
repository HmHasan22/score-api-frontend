...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function init_template(){
       ...
       //Back to Top
        function backUp(){
            var backToTop = document.querySelectorAll('.back-to-top-icon, .back-to-top-badge, .back-to-top, [data-back-to-top]');
            if(backToTop){
        ...
        if(fixedAds || scrollAds){
         ...
         //Scroll Ads
        var scrollItems = document.querySelectorAll('.scroll-ad, .header-auto-show, .header')
        if(scrollItems.length){
            var scrollAd = document.querySelectorAll('.scroll-ad');
            var scrollHeader = document.querySelectorAll('.header-auto-show');
            window.addEventListener('scroll', function() {
                if (document.querySelectorAll('.scroll-ad, .header-auto-show, .header').length) {
					...
					if(passed_header){
						document.querySelectorAll('.back-to-top-icon')[0].classList.add('back-to-top-visible');
					}
					if(inside_header){
						document.querySelectorAll('.back-to-top-icon')[0].classList.remove('back-to-top-visible');
					}
                }
            });
        }
